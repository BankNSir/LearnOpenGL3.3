...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, brick_depthTexture);
		...
		normalMappingInShadowMapShader.setInt("parallaxDepthMap", 3);
		...
		normalMappingInShadowMapShader.setFloat("parallaxOffsetScale", 0.1f);
